  ...
  if (parkCode == 'pnc') {
    ...
    CKEDITOR.addStylesSet('drupal',
      [
        ...
        {name: 'Titre 3 - bleu', element: 'h3', attributes : {'class': 'cke-h3 cke-blue1'}},
        {name: 'Titre 4 - gris foncé', element: 'h4', attributes : {'class': 'cke-h4 cke-dark-grey1'}},
    ...
    CKEDITOR.addStylesSet('drupal',
      [
        ...
        {name: 'Titre 5', element: 'h5'},
        {name: 'Titre 3 - bleu', element: 'h3', attributes : {'class': 'cke-h3 cke-blue1'}},
        {name: 'Titre 3 - marron', element: 'h3', attributes : {'class': 'cke-h3 cke-brown1'}},
        {name: 'Titre 3 - vert', element: 'h3', attributes : {'class': 'cke-h3 cke-green1'}},
        {name: 'Titre 4 - beige', element: 'h4', attributes : {'class': 'cke-h4 cke-beige1'}},
        {name: 'Paragraphe beige', element: 'p', attributes : {'class': 'cke-p cke-beige1'}},
        {name: 'Paragraphe bleu', element: 'p', attributes : {'class': 'cke-p cke-blue1'}},
        {name: 'Paragraphe marron', element: 'p', attributes : {'class': 'cke-p cke-brown1'}},
        {name: 'Paragraphe vert', element: 'p', attributes : {'class': 'cke-p cke-green1'}},
